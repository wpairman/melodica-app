        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription className={gardenStage === "reflective" ? "text-blue-400" : "text-black"}>{getGardenDescription()}</CardDescription>
            </div>
            {gardenStage === "reflective" && (
        ...
        <CardContent>
          {gardenStage === "empty" ? (
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <h3 className="text-lg font-medium text-black mb-2">Plant Your First Seed</h3>
              <p className="text-black">Log your first mood to start growing your emotional garden</p>
            </div>
          ) : (
